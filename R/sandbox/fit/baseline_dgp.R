...
pwdmy_variables <- step_0_define_basic_parameters(
  years = 5,
...
df_ads_step2 <- step_2_ads_spend_biased(
  my_variables = my_variables,
  spend_base <- c(100000, 100000),
  spend_trend <- c(0.3, 0.0),
  spend_temp_var <- c(0.0, 2.0),
...
print(OutputCollect)
select_model <- "2_117_8" # Pick one of the models from OutputCollect to proceed
